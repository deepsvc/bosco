  ...
  return (
    <div className="container ">
      <div className="row text-start justify-content-center ">
        ...
        <p>
          Are you looking to spruce up the appearance of your bike?<br /> What if we
          told you, you can see your bike in that colour you have always dreamt
          of?<br /> You have definitely reached the right place to get it done.<br /> Please
          fill the below form for a hassle-free custom paint job experience.
        </p>
        <Formik
...
export default CustomPaintJobForm;
